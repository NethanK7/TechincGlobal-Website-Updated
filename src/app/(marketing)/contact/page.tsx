...
export const metadata: Metadata = {
    ...
    description:
        "Get in touch with TECHINCGLOBAL for a free ERP consultation. Contact Sri Lanka's authorized Frappe Technologies partner for Frappe ERP implementation and advisory.",
